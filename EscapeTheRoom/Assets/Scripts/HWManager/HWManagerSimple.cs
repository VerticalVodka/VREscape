...
namespace VREscape
{
    public class HWManagerSimple : MonoBehaviour
    {
        ...
        public void Update()
        {
            _buttons[Enums.ButtonEnum.Button1] = Input.GetKeyDown(KeyCode.Alpha1);
            _buttons[Enums.ButtonEnum.Button2] = Input.GetKeyDown(KeyCode.Alpha2);
            _buttons[Enums.ButtonEnum.Button3] = Input.GetKeyDown(KeyCode.Alpha3);
            _buttons[Enums.ButtonEnum.Button4] = Input.GetKeyDown(KeyCode.Alpha4);
            ...
            _buttons[Enums.ButtonEnum.Rotary1] = Input.GetKeyDown(KeyCode.DownArrow);
            ...
            _buttons[Enums.ButtonEnum.Rotary1] = Input.GetKeyDown(KeyCode.S);
        }
    }
}